...
namespace dxowl
{
    ...
    public:
        ...
        void loadVertexSubData(
            ID3D11DeviceContext3 *d3d11_ctx,
        ...
        void setVertexBuffers(ID3D11DeviceContext3 *d3d11_ctx, UINT const base_vertex);
        void setIndexBuffer(ID3D11DeviceContext3 *d3d11_ctx, UINT const first_index);
    ...
    inline void Mesh::setVertexBuffers(ID3D11DeviceContext3 *d3d11_ctx, UINT const base_vertex)
    {
    ...
    inline void Mesh::setIndexBuffer(ID3D11DeviceContext3 *d3d11_ctx, UINT first_index)
    {
    ...
    inline VertexDescriptor EngineCore::Graphics::Dx11::Mesh::getVertexLayout() const
    {
