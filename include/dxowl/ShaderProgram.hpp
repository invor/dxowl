...
namespace dxowl
{
    ...
    public:
        ...
        void setInputLayout(ID3D11DeviceContext3 *d3d11_ctx);
        void setVertexShader(ID3D11DeviceContext3 *d3d11_ctx);
        void setGeometryShader(ID3D11DeviceContext3 *d3d11_ctx);
        void setPixelShader(ID3D11DeviceContext3 *d3d11_ctx);
    ...
    inline void ShaderProgram::setInputLayout(ID3D11DeviceContext3 *d3d11_ctx)
    {
        d3d11_ctx->IASetInputLayout(m_inputLayout.Get());
    }

    inline void ShaderProgram::setVertexShader(ID3D11DeviceContext3 *d3d11_ctx)
    {
    ...
    inline void ShaderProgram::setGeometryShader(ID3D11DeviceContext3 *d3d11_ctx)
    {
    ...
    inline void ShaderProgram::setPixelShader(ID3D11DeviceContext3 *d3d11_ctx)
    {
